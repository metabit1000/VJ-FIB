...
void Sprite::resize(float size) { //lo hacemos grande, por ahora	

	glm::mat4 modelview = glm::translate(glm::mat4(1.0f), glm::vec3(position.x, position.y, 0.f));
	modelview = glm::scale(modelview, glm::vec3(size, size, 0.f));
	modelview = glm::translate(modelview, glm::vec3(-25.f, -25.f, 0.f));
	shaderProgram->setUniformMatrix4f("modelview", modelview);
	shaderProgram->setUniform2f("texCoordDispl", texCoordDispl.x, texCoordDispl.y);
...
void Sprite::move(glm::vec2 trans) { //lo hacemos grande, por ahora	

	glm::mat4 modelview = glm::translate(glm::mat4(1.0f), glm::vec3(position + trans, 0.f));
